package com.hmyh.moviejc.network.feature.toprated.response
...
data class TopRatedMovieResponse(
    ...
    @Json(name = "results") val movieList: List<TopRatedMovieItemResponse>? = null,
    @Json(name = "total_pages") val totalPages: Long? = null
)

@JsonClass(generateAdapter = true)
data class TopRatedMovieItemResponse(
