package com.hmyh.moviejc.movieui.feature.upcoming
...
@Composable
fun UpcomingContent(
    movieListState: ListViewState<UpcomingMovieItemVO>,
    ...
    when (movieListState) {
        ...
        is ListViewState.Success -> {
            ...
            if (movieList.isEmpty()) {
                UpcomingEmptyMessage(text = "No movies found")
            } else {
                UpcomingMovieGrid(
                    movieList = movieList,
                    isLoadingMore = isLoadingMore,
...
@Composable
private fun UpcomingMovieGrid(
    movieList: List<UpcomingMovieItemVO>,
    isLoadingMore: Boolean,
    canLoadMore: Boolean,
    onLoadMore: () -> Unit,
    onItemClick: (Long) -> Unit
...
@Composable
private fun UpcomingEmptyMessage(text: String) {
    Column(
        modifier = Modifier.fillMaxSize(),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
...
@Composable
fun UpcomingMovieGridItem(
    movie: UpcomingMovieItemVO,
    onItemClick: (Long) -> Unit
) {
...
@Composable
fun UpcomingTopAppBarPreview() {
    UpcomingTopAppBar(onBackClick = {})
}

@Preview(showBackground = true)
@Composable
fun UpcomingContentPreview() {
