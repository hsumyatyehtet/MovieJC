package com.hmyh.moviejc.movieui.feature.nowplaying
...
fun NowPlayingContent(
    movieListState: ListViewState<NowPlayingMovieItemVO>,
    ...
    when (movieListState) {
        ...
        is ListViewState.Success -> {
            ...
            if (movieList.isEmpty()) {
                NowPlayingEmptyMessage(text = "No movies found")
            } else {
                NowPlayingMovieGrid(
                    movieList = movieList,
                    isLoadingMore = isLoadingMore,
...
@Composable
private fun NowPlayingMovieGrid(
    movieList: List<NowPlayingMovieItemVO>,
    isLoadingMore: Boolean,
    canLoadMore: Boolean,
    onLoadMore: () -> Unit,
    onItemClick: (Long) -> Unit
...
@Composable
private fun NowPlayingEmptyMessage(text: String) {
    Column(
        modifier = Modifier.fillMaxSize(),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
...
@Composable
fun NowPlayingMovieGridItem(
    movie: NowPlayingMovieItemVO,
    onItemClick: (Long) -> Unit
) {
...
@Composable
fun NowPlayingTopAppBarPreview() {
    NowPlayingTopAppBar(onBackClick = {})
}

@Preview(showBackground = true)
@Composable
fun NowPlayingContentPreview() {
    val sampleMovies = listOf(
        NowPlayingMovieItemVO(
            id = 1,
