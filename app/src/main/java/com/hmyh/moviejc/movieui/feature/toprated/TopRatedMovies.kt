package com.hmyh.moviejc.movieui.feature.toprated
...
@Composable
fun TopRatedContent(
    movieListState: ListViewState<TopRatedMovieItemVO>,
    ...
    when (movieListState) {
        ...
        is ListViewState.Success -> {
            ...
            if (movieList.isEmpty()) {
                TopRatedEmptyMessage(text = "No movies found")
            } else {
                TopRatedMovieGrid(
                    movieList = movieList,
                    isLoadingMore = isLoadingMore,
...
private fun TopRatedMovieGrid(
    movieList: List<TopRatedMovieItemVO>,
    isLoadingMore: Boolean,
    canLoadMore: Boolean,
    onLoadMore: () -> Unit,
    onItemClick: (Long) -> Unit
...
@Composable
private fun TopRatedEmptyMessage(text: String) {
    Column(
        modifier = Modifier.fillMaxSize(),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
...
@Composable
fun TopRatedMovieGridItem(
    movie: TopRatedMovieItemVO,
    onItemClick: (Long) -> Unit
) {
...
@Composable
fun TopRatedTopAppBarPreview() {
    TopRatedTopAppBar(onBackClick = {})
}

@Preview(showBackground = true)
@Composable
fun TopRatedContentPreview() {
